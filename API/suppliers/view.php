...
if (!empty($searchValue)) {
    $query .= " WHERE supplier_id LIKE '%$searchValue%' 
    OR supplier_code LIKE '%$searchValue%' 
    OR supplier_name LIKE '%$searchValue%'"; // Add more columns as needed
}
