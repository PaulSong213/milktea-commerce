...
<body>
    <div class="table w-100 p-4">
        <h2 class="mt-4 mb-5">PROMO LIST</h2>
    ...
    <script type="module">
        ...
        $(document).ready(function() {
            ...
            const table = $('#example').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '/milktea-commerce/API/promo/view.php',
                    dataType: 'JSON',
                    type: 'POST',
                    data: function(d) {
                        d.draw = d.draw || 1;
                ...
                columns: [{
                        data: 'promoImage', // Column 2: Image
                    ...
                    },
                    {
                        ...
                        render: (data, type, row) => {
                            return toFormattedDate(data.expiryDate);
                        }
                    },
                    {
                        data: null,
