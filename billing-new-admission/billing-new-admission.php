                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="my-3">
                            ...
                            <input type="text" readonly id="encoderID" name="encoderID" class="form-select form-disabled" placeholder="Enter the encoder" list="employeeList" correctData="employeesData" value="<?= $currentLoggedInEncoder; ?>" sql-value="<?= $currentLoggedInEncoderID; ?>" required isvalidated="true">
                        </div>
