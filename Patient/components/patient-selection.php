...
<div class="form-group">
    <label for="patientAccountName">Last Name</label>
    <div class="input-group">
        <input type="text" class="form-control" name="patientAccountName" list="patientList" correctData="patientsData" placeholder="Enter Patient Account Name" oninput="convertToUpperCase(this)" required id="patientAccountName">
        <?php require_once('../API/datalist/patient-listinput.php') ?>
