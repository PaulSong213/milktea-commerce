...
<body>
    <div class="table w-100 p-4">
        <h2 class="mt-4 mb-5">PRODUCT CATEGORY</h2>
            ...
            $('#example').on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '/milktea-commerce/API/itemType/delete.php', // Change this path to the actual delete.php file path
                            type: 'POST',
                            data: {
                                id: id
                            },
